export const stockData = [
    {
      ...
      description: "An apple is an edible fruit produced by an apple tree (Malus domestica). Apple trees are cultivated worldwide and are the most widely grown species in the genus Malus. The tree originated in Central Asia, where its wild ancestor, Malus sieversii, is still found today. Apples have been grown for thousands of years in Asia and Europe and were brought to North Am",
    },
    {
      title: "Banana",
      link: "https://en.wikipedia.org/wiki/Banana",
      description: "A banana is an elongated, edible fruit – botanically a berry[1][2] – produced by several kinds of large herbaceous flowering plants in the genus Musa.[3] In some countries, bananas used for cooking may be called 'plantains', distinguishing them from dessert bananas. The fruit is variable in size, color, and firmness, but is usually elongated and curved, with s",
    },
    {
      title: "Orange",
      link: "https://en.wikipedia.org/wiki/Orange_(fruit)",
      description: "An orange is a fruit of various citrus species in the family Rutaceae (see list of plants known as orange); it primarily refers to Citrus × sinensis,[1] which is also called sweet orange, to distinguish it from the related Citrus × aurantium, referred to as bitter orange. The sweet orange reproduces asexually (apomixis through nucellar embryony); varieties of ",
    },
    {
      title: "Avocado",
      link: "https://en.wikipedia.org/wiki/Avocado",
      description: "The avocado (Persea americana), a tree likely originating from south-central Mexico,[3][4][5] is classified as a member of the flowering plant family Lauraceae.[3] The fruit of the plant, also called an avocado (or avocado pear or alligator pear), is botanically a large berry containing a single large seed.[6] Avocado trees are partially self-pollinating, and ",
    },
    {
      title: "Mango",
